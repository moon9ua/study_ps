...
<p>아기 상어는 <lighter data-id="lgt3714330138445523" data-bundle-id="3714330138445523" data-slot-id="0" style="background-color: rgb(255, 255, 131);">자신의 크기보다 큰 물고기가 있는 칸은 지나갈 수 없고</lighter>, 나머지 칸은 모두 지나갈 수 있다. 아기 상어는 자신의 크기보다 작은 물고기만 먹을 수 있다. 따라서, 크기가 같은 물고기는 먹을 수 없지만, 그 물고기가 있는 칸은 지나갈 수 있다.</p>
...
<ul>
	...
	<ul>
		...
		<li>거리가 가까운 물고기가 많다면, <lighter data-id="lgt23171270199093486" data-bundle-id="23171270199093486" data-slot-id="0" style="background-color: rgb(255, 255, 131);">가장 위에 있는 물고기, 그러한 물고기가 여러마리라면, 가장 왼쪽에 있는 물고기</lighter>를 먹는다.</li>
	</ul>
	</li>
</ul>
